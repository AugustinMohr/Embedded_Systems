	soc_system u0 (
		...
		.lcd_controller_0_conduit_end_export_cs_n    (<connected-to-lcd_controller_0_conduit_end_export_cs_n>),    // lcd_controller_0_conduit_end.export_cs_n
		.lcd_controller_0_conduit_end_export_data    (<connected-to-lcd_controller_0_conduit_end_export_data>),    //                             .export_data
		.lcd_controller_0_conduit_end_export_d_c_n   (<connected-to-lcd_controller_0_conduit_end_export_d_c_n>),   //                             .export_d_c_n
		.lcd_controller_0_conduit_end_export_lcd_on  (<connected-to-lcd_controller_0_conduit_end_export_lcd_on>),  //                             .export_lcd_on
		.lcd_controller_0_conduit_end_export_rd_n    (<connected-to-lcd_controller_0_conduit_end_export_rd_n>),    //                             .export_rd_n
		.lcd_controller_0_conduit_end_export_reset_n (<connected-to-lcd_controller_0_conduit_end_export_reset_n>), //                             .export_reset_n
		.lcd_controller_0_conduit_end_export_wr_n    (<connected-to-lcd_controller_0_conduit_end_export_wr_n>),    //                             .export_wr_n
